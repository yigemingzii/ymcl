...
public final class Metadata {
    ...
    public static final String NAME = "YMCL";
    public static final String FULL_NAME = "YBC Minecraft! Launcher";
    public static final String VERSION = System.getProperty("ymcl.version.override", JarUtils.getManifestAttribute("Implementation-Version", "@develop@"));
